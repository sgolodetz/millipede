...
The collection of regional minimum edges of a graph $ is a connected
subgraph of $ whose edges have the same weight as each other, and
whose adjacent edges in $ have strictly higher weights. The
