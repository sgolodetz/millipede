...
getAdjacencyList arr = do 
  ...
  ;pickNAdjacencies (c*d-1) (c,d) (fromList e) arr brr []
  }
...
-- pickNAdjacencies ::  Int-> Point ->Heap Adjacency-> UArray Point Int -> IOArray Point [(Int,Voxel)] -> IO (IOArray Point [(Int,Voxel)])
-- pickNAdjacencies 0 is es ar ls  = do {return $!  ls}
-- pickNAdjacencies n is h ar ls   = do
--   {
...
--        ;pickNAdjacencies (n-1) is h'' ar ls ((w,a,b)) 
--        }
--      else do {(pickNAdjacencies n is h' ar ls)}
--   }
