...
public:
	...
	{
		virtual ~Listener() {}
		virtual void slice_location_changed(bool sliceChanged) = 0;
...
private:
	...
	{
		void slice_location_changed(bool sliceChanged)	{ multicast(boost::bind(&Listener::slice_location_changed, _1, sliceChanged)); }
