...
private:
	...
	//#################### CONSTRUCTORS ####################
public:
	MosaicImageCreator(const VolumeIPF_CPtr& volumeIPF, int layerIndex, bool withBoundaries, MosaicImage::Pointer& mosaicImage)
	:	m_layerIndex(layerIndex), m_mosaicImage(mosaicImage), m_volumeIPF(volumeIPF), m_withBoundaries(withBoundaries)
	{}
